...
@Mapper
public interface OpsReportRunMapper extends BaseMapper<OpsReportRun> {

    List<OpsReportQualityAggVO> listFailedQualityResults(@Param("datasourceIds") List<Long> datasourceIds,
