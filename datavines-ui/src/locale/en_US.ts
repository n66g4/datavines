export default {
    ...
    jobs_batch_import_split_tip: 'There is only one template (one rule per Excel/CSV row). Split mode is chosen at import: one job per rule (default) creates one job per row; one job per table merges rows of the same table into a multi-metric job.',
    ...
    jobs_batch_import_select_file: 'Select Excel/CSV/JSON',
    jobs_batch_import_tpl_xlsx: 'Download Excel Template',
