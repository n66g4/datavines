export default {
    ...
    jobs_batch_import_split_tip: '模板只有一种（Excel/CSV 一行一条规则）。拆分模式在导入时选择：一规则一作业（默认）按行各建一个作业；一表一作业按 table 合并为多指标作业。',
    jobs_batch_import_split_rule: '一规则一作业',
    jobs_batch_import_split_table: '一表一作业(多指标)',
    ...
    jobs_batch_import_error_store_tip: '可选，建议选择 local-error-file',
    jobs_batch_import_file: '导入文件',
    jobs_batch_import_select_file: '选择 Excel/CSV/JSON',
    jobs_batch_import_tpl_xlsx: '下载 Excel 模板',
    ...
    error_table_store_type_tip: 'file 类型将错误明细落为服务器本地 CSV 文本文件（.csv），不是 Excel/Markdown。',
    error_title: '存储管理',
