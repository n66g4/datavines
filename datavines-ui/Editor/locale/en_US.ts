export default {
    ...
    lineage_both: 'All',
    lineage_add: 'Add Lineage',
    lineage_add_by_sql: 'Parse SQL',
    lineage_delete: 'Delete Lineage',
    lineage_delete_confirm: 'Confirm to delete this lineage?',
    lineage_source_table: 'Source Table',
    lineage_target_table: 'Target Table',
    lineage_empty: 'No lineage found',
    lineage_empty_desc: 'No lineage established yet',
    lineage_detail: 'Lineage Detail',
    lineage_column_mapping: 'Column Lineage',
    lineage_source_type: 'Source Type',
    ...
    lineage_select_datasource: 'Select DataSource',
    lineage_select_database: 'Select Database',
    lineage_select_table: 'Select Table',
