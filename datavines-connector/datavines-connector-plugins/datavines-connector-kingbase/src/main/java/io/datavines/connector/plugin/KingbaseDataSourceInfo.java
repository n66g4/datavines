...
public class KingbaseDataSourceInfo extends BaseJdbcDataSourceInfo {

    private final Logger logger = LoggerFactory.getLogger(KingbaseDataSourceInfo.class);

    public KingbaseDataSourceInfo(Map<String,String> param) {
        super(param);
    }

    @Override
    public String getAddress() {
        return "jdbc:kingbase8://" + getHost() + ":" + getPort();
    }
